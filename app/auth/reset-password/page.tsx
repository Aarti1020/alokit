    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-950 via-stone-900 to-amber-900 flex items-center justify-center px-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-cinzel text-2xl font-bold text-stone-800">Reset Password</h1>
          <p className="text-stone-500 font-jost text-sm mt-1">Set a new password for your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-jost font-medium text-stone-700 mb-1">Reset Token *</label>
            <input
              type="text"
              required
              value={token}
          ...
          <div>
            <label className="block text-sm font-jost font-medium text-stone-700 mb-1">New Password *</label>
